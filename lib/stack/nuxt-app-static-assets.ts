 ...
 */
const getNuxtAppCustomAssetConfigs = (srcDir: string|undefined = undefined): StaticAssetConfig[] => {
    ...
    const customAssetsSourcePath = `.${srcDir ? `/${srcDir}` : ''}/public`;
 ...
 */
export const getNuxtAppStaticAssetConfigs = (srcDir: string|undefined = undefined): StaticAssetConfig[] => {
    return [...getNuxtAppBuildAssetConfigs(), ...getNuxtAppCustomAssetConfigs(srcDir)];
};